...
void pos_cb(const nav_msgs::Odometry::ConstPtr& msg)
{
    ...
    tf::Matrix3x3 R_BI(current_att_quat);


    R_BI = R_BI.transpose();


    current_vel_rate_b = {R_BI[0][0] * current_vel_rate.at(0) + R_BI[0][1] * current_vel_rate.at(1) + R_BI[0][2] * current_vel_rate.at(2),
                         R_BI[1][0] * current_vel_rate.at(0) + R_BI[1][1] * current_vel_rate.at(2) + R_BI[1][2] * current_vel_rate.at(2),
                          R_BI[2][0] * current_vel_rate.at(0) + R_BI[2][1] * current_vel_rate.at(2) + R_BI[2][2] * current_vel_rate.at(3)};
  ...
  //  }
        ...
        if (!nmpc_pc->return_control_init_value())
        {
            ...
            current_states = {current_pos_att.at(0),
                              ...
                              current_vel_rate_b.at(0),
                              current_vel_rate_b.at(1),
                              current_vel_rate_b.at(2),
            ...
            */
            ...
            std::cout << "vel_body_x = ";
            std::cout << current_vel_rate_b.at(0) << ",";
            std::cout << "\n";
